...
<div class="wrap">
	...
	foreach ($categories as $cat) {
        ?>
            <li style="font-weight: normal;"><a href="<?php echo get_option('siteurl') ?>/wp-content/plugins/blog-as-pdf/generate.php?category_id=<?php echo $cat->term_id; ?>"><span style="padding-top: 10px;"><?php echo $cat->name; ?></span></a></li>
        <?php
	}
	?>
	</ul>
